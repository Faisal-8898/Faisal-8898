return {
	...
	config = function()
		...
		-- 	cmd = { "rust-analyzer" }, -- This will use the rustup-installed binary in your PATH
		-- 	settings = {
		-- 		["rust-analyzer"] = {
		-- 			-- Add any custom rust-analyzer settings here
		-- 			checkOnSave = {
		...
		mason_lspconfig.setup_handlers({
			...
			["graphql"] = function()
				...
				lspconfig["graphql"].setup({
					capabilities = capabilities,
					filetypes = { "graphql", "gql", "svelte", "typescriptreact", "javascriptreact", "java" },
				})
			end,
			["emmet_ls"] = function()
			...
			["jdtls"] = function()
				...
				lspconfig["jdtls"].setup({
					capabilities = capabilities,
					-- Add any Java-specific settings here
				})
			end,
			["lemminx"] = function()
				-- Configure XML language server (useful for Spring configurations)
			...
			["gradle_ls"] = function()
				-- Configure Gradle language server
